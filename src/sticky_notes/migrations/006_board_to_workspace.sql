...
-- Recreate task_history: fix FK reference back to the new tasks table
-- (SQLite redirects the FK to _tasks_old on rename -- must recreate to restore correct reference)
...
-- Indexes for task_history (dropped with _task_history_old)
