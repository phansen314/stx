...
- **Dependencies** — `stx dep create task-0003 task-0001` means task-0003 is blocked by task-0001.
...
- **Group dependencies** — `stx group dep create --group <title> --blocked-by <title>` (by title within the same project).
